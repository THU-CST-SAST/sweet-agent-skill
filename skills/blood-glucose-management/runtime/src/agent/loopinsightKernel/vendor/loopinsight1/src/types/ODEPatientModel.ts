...
import type { ModuleProfile } from './ModuleProfile'
import type ParametricModule from './ParametricModule'
import { PatientInput, PatientOutput } from './Patient'
import type { PatientState, StateDescription } from './Patient'
