...
import type IOModule from './IOModule'
import type { PatientInput, PatientInputOverTime, PatientOutput, VectorSignalDescription } from './Signals'
...
export {PatientInput, PatientOutput} from './Signals'
