...
import DailyProfile, { InterpolationMethod } from '../../common/DailyProfile'
...
import { createPatientFromODE } from '../AbstractODEPatient'
import { UvaPadova_T1DMS, parameterDescription as parameterDescriptionT1DMS, stateDescription } from './UvaPadova_T1DMS'
import type { State } from './UvaPadova_T1DMS'
